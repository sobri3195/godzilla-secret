...
from godzilla.logger import get_logger, setup_logger
from godzilla.processor import Processor, SignatureMatch
from godzilla.utils import (col_print, find_extension,
                                        get_available_names)
...
godzilla-secret <PATH_TO_FOLDER> -f aws microsoft crypto digitalocean ssh sql google

'''
argument_parser = argparse.ArgumentParser(
    prog='godzilla-secret',
